  ...
  class SignatureAnalyzer
    ...
    class Method
      class << self
        ...
        def extract_signature(member, visibility)
          case member
        ...
        def format_attribute(attr, visibility, attr_type)
          name = case attr_type
                 when :writer
                   "#{attr.name}="
                 else
        ...
        def format_method_definition(method_def, visibility)
        ...
        def build_overload_item(overload_param_info, overload_method_type)
        ...
        def build_method_result(method_def, visibility, param_info, primary_method_type,
                                overloads)
