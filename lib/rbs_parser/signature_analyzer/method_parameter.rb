  ...
  class SignatureAnalyzer
    ...
    class MethodParameter
      class << self
        ...
        def extract_block_parameter(method_type)
        ...
        def build_block_parameters(block)
        ...
        def extract_required_positional_parameters(method_type)
        ...
        def extract_optional_positional_parameters(method_type)
          return [] unless method_type.type.is_a?(RBS::Types::Function)
        ...
        def extract_rest_positional_parameters(method_type)
        ...
        def extract_required_keyword_parameters(method_type)
          return [] unless method_type.type.is_a?(RBS::Types::Function)
        ...
        def extract_optional_keyword_parameters(method_type)
          return [] unless method_type.type.is_a?(RBS::Types::Function)
        ...
        def extract_rest_keyword_parameters(method_type)
        ...
        def build_parameter_hash(name, type, kind, default_name = nil)
          Parameter.new(
